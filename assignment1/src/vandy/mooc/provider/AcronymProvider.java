...
public class AcronymProvider extends ContentProvider {
        ...
        case ACRONYMS:
            ...
            try {
                ...
                for (ContentValues value : contentValues) {
                    long id = db.insert(AcronymContract.AcronymEntry.TABLE_NAME, null, value);
    ...
    public Cursor query(Uri uri,
        ...
        case ACRONYM: 
            ...
            retCursor = queryBuilder.query(mOpenHelper.getReadableDatabase(), projection, rowId, null, null, null, sortOrder);
